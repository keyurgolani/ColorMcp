...
describe('PNG Generation Performance Benchmarks', () => {
  ...
  describe('Color Comparison PNG Generation Performance', () => {
    ...
    it('should generate complex comparison (5 sets) under 800ms', async () => {
  ...
  describe('Memory Usage and File Size', () => {
    it('should generate palette PNG under 5MB', async () => {
      ...
      expect(result.success).toBe(true);
      expect((result.data as any).file_size).toBeLessThan(5 * 1024 * 1024);
    });
    ...
    it('should generate gradient PNG under 3MB', async () => {
      ...
      expect(result.success).toBe(true);
      expect((result.data as any).file_size).toBeLessThan(3 * 1024 * 1024);
    });
    ...
    it('should generate comparison PNG under 8MB', async () => {
      ...
      expect(result.success).toBe(true);
      expect((result.data as any).file_size).toBeLessThan(8 * 1024 * 1024);
    });
  });
